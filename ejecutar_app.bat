...
rem === Timestamp (para cache-busting) ===
...
rem === 3) Inyectar versionado en live.mobile.html (solo APP) ===
echo [4/6] Inyectando data.js y versiones en live.mobile.html >>"%LOG%"
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
...
rem === 4) Actualizar Service Worker (CACHE_NAME nuevo) ===
...
rem === 6) Servidor local y abrir APP ===
